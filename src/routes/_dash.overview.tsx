  ...
  useEffect(() => {
    ...
    const loadEvents = async () => {
      try {
        ...
        // Compute unique active users using the anonId generated by the tracker, falling back to id if it's missing (legacy data)
        const uniqueUsers = new Set(events.map((e: any) => e.anonId || e.id));
